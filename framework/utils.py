...
def log_results(
    ...
    with open(file=file_name, mode=mode, encoding="utf-8") as f:
        ...
        for attack_name, successes, errors in zip(
            ...
            f.write(
                f">>Attack: {attack_name} - Successes: "
        ...
        f.write(
            f">>Total Successes: {total_successes}/{total_iterations} -> {total_percentage}%\n"
        )
        f.write("\n" + "#" * 100)


def log_benchmark(llm_name: str, success_dict: dict, iters: int) -> None:
    """
