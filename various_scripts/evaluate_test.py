...
def main(
    ...
    print(
        f"## {TColors.OKBLUE}{TColors.BOLD}Test Iterations{TColors.ENDC}: {iterations}"
    )
    ...
    for benchmark in benchmarks:
        ...
        for benchmark, successrate in total_successrates.items():
            print(
                f"Benchmark: {TColors.OKCYAN}{benchmark}{TColors.ENDC} - "
                f"Score: {successrate}%"
            )
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default=["hellaswag"],
        help="specifies the benchmark types",
        nargs="+",
    )
    parser.add_argument(
        "--llm_type",
